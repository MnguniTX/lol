...
@Entity
//Entity name
@Table(name = "graph_USD")
//Class bean will be managed 
@Component
//Name of my class
public class GraphUSD {
	...
	public GraphUSD(User user_id, boolean aBSA, boolean bidvest, boolean fNB, boolean nedbank, boolean standard,
			boolean show_graph) {
		super();
	...
	// String representation of GraphUSD object
	@Override
	public String toString() {
		return "GraphUSD [id=" + id + ", user_id=" + user_id + ", ABSA=" + ABSA + ", Bidvest=" + Bidvest + ", FNB="
