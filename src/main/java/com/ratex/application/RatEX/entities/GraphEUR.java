...
public class GraphEUR {
	...
	public GraphEUR(User user_id, boolean aBSA, boolean bidvest, boolean fNB, boolean nedbank, boolean standard,
			boolean show_graph) {
		super();
	...
	// String representation of GraphEUR object
	@Override
	public String toString() {
		return "GraphEUR [id=" + id + ", user_id=" + user_id + ", ABSA=" + ABSA + ", Bidvest=" + Bidvest + ", FNB="
