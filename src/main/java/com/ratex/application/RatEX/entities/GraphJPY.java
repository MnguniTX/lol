...
@Entity
//Entity name
@Table(name = "graph_JPY")
//Class bean will be managed 
@Component
//Name of my class
public class GraphJPY {
	...
	public GraphJPY(User user_id, boolean aBSA, boolean bidvest, boolean fNB, boolean nedbank, boolean standard,
			boolean show_graph) {
		super();
	...
	// String representation of GraphJPY object
	@Override
	public String toString() {
		return "GraphJPY [id=" + id + ", user_id=" + user_id + ", ABSA=" + ABSA + ", Bidvest=" + Bidvest + ", FNB="
